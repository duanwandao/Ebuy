			...
			<form action="comment_save.action" method="post" onsubmit="return checkForm()">
				<table>
					<tr>
						...
						<td><input class="text" type="text" readonly=”readonly” id="nickName"  name="comment.nickName" />
						</td>
					</tr>
					<tr>
...
<script type="text/javascript">
	...
	if (${empty currentUser}) {
		$("#nickName").val(returnCitySN["cip"]+" "+returnCitySN.cname);
	}else{
		$("#nickName").val("${currentUser.userName}");
	}
