...
<script type="text/javascript">
	...
	function searchProduct(){
		$("#dg").datagrid('load',{
			"s_productName":$("#s_productName").val()
		});
	}
...
<body style="margin:1px;">
	<table id="dg" title="商品管理" class="easyui-datagrid" fitColumns="true" width="auto" pagination="true" rownumbers="true" url="product_list.action" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		...
		<div>
			&nbsp;商品名称：&nbsp;<input type="text" id="s_productName" onkeydown="if(event.keyCode==13) searchProduct()"/>
