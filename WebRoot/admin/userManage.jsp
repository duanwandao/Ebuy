...
<body style="margin:1px;">
	<table id="dg" title="用户管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true" url="user_list.action" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		...
		<div>
			&nbsp;用户名：&nbsp;<input type="text" id="s_userName" onkeydown="if(event.keyCode==13) searchUser()"/>
