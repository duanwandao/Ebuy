...
public class ProductSmallTypeAction extends ActionSupport{
	...
	public String comboList()throws Exception{
		...
		List<ProductSmallType> productSmallTypeList=productSmallTypeService.findAllSmallTypeList(s_productSmallType,null);
		JsonConfig jsonConfig=new JsonConfig();
		jsonConfig.setExcludes(new String[]{"productList","bigType"});
	...
	public String list()throws Exception{
		...
		List<ProductSmallType> productSmallTypeList=productSmallTypeService.findAllSmallTypeList(s_productSmallType, pageBean);
